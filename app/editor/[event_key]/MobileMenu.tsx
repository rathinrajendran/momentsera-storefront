...
const ToolsMenuItems = [
  {
    id: "sections",
    label: "Sections",
    icon: <LayoutGrid className="h-5 w-5" strokeWidth={1} />,
    onClick: onSectionClick,
  },
  {
    id: "preview",
    label: "Preview",
    icon: <Eye className="h-5 w-5" strokeWidth={1} />,
    onClick: onOtherClick,
  },
  {
    id: "publish",
    label: "Publish",
    icon: <Send className="h-5 w-5" strokeWidth={1} />,
    onClick: onOtherClick,
  },
  {
    id: "share",
    label: "Share",
    icon: <Share2 className="h-5 w-5" strokeWidth={1} />,
    onClick: onOtherClick,
  },
  {
    id: "link",
    label: "Link",
    icon: <Link2 className="h-5 w-5" strokeWidth={1} />,
    onClick: onOtherClick,
  },
];
  ...
  return (
    <div className={`${className} fixed flex right-0 bottom-0 left-0 z-20`}>
      <nav className="flex h-[60px] w-full items-center justify-around rounded-t-3xl bg-amber-200">
