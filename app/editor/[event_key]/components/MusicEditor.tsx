...
import { ChevronLeft, ChevronRight, Music, Pause, Play, Save, X } from "lucide-react";
...
export default function MusicEditor({ onBack, handleBack, eventKey }: { onBack: () => void; handleBack: () => void; eventKey: string }) {
  /* ---------------- HOOKS ---------------- */
  ...
  return (
    <div className="animate-in fade-in flex h-full flex-col rounded-xl duration-500 md:rounded-none">
      <EditorHeader title="Music" handleBack={handleBack} />
            ...
            <section>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      <FormLabel>Audio Player Layout</FormLabel>
                      <FormControl>
                        <RadioGroup
                          value={field.value}
                          onValueChange={(value) => {
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      <div className="flex items-center justify-between">
                        ...
                        <FormLabel>{field.value || 60}%</FormLabel>
                      </div>
                      <FormControl>
