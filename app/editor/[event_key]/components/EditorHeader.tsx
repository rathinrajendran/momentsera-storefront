...
export default function EditorHeader({ handleCancel, title }: { handleCancel: () => void; title: string }) {
  ...
  return (
    <div className="top-0 z-[9] flex h-[50px] items-center justify-center gap-3 border-slate-100 bg-white md:sticky md:justify-start md:border-t md:border-b hidden md:block">
