    ...
    <div className="flex min-h-screen bg-neutral-50">
      ...
      <aside className="hidden w-72 border-r border-neutral-200 bg-white lg:flex lg:flex-col">
        <div className="border-b border-neutral-200 p-6">
          <h1 className="text-xl font-bold">Evllyne Studio000</h1>
          <p className="mt-1 text-sm text-neutral-500">Admin Dashboard</p>
        </div>

        <nav className="max-h-[calc(100dvh-200px)] flex-1 p-4">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href ? "bg-black text-white" : "text-neutral-600 hover:bg-neutral-100",
                  )}
                >
                  <Icon size={18} />
                  {item.label}
      ...
      <div className="flex flex-1 flex-col">
        ...
        {/* Main */}
        <main className="max-h-[calc(100dvh-66px)] flex-1 overflow-auto p-6">
          {/* Header */}
          <div className="mb-8">
