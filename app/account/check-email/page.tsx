...
// 1. Isolate the hook usage and content into an inner component
...
// 2. Wrap the dynamic content with Suspense in the main page export
export default function CheckEmailPage() {
  return (
    <AuthLayout title="Check Your Email">
      <Suspense fallback={<div className="text-center text-sm text-gray-500">Loading inbox reference...</div>}>
        <CheckEmailContent />
      </Suspense>
    </AuthLayout>
  );
